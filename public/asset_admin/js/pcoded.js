...
// more-details end
$("body").append('<div class="fixed-button active"><a href="https://1.envato.market/qG0m5" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-user" aria-hidden="true"></i> Copyright Abdul Munif</a> </div>');
